...
export function Footer() {
  ...
  return (
    <footer className="relative border-t border-border/50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="absolute inset-0 page-ambient opacity-30 pointer-events-none" aria-hidden />
      <div className="relative max-w-6xl mx-auto glass-card p-8 md:p-10">
        <Reveal>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="font-bold text-foreground mb-3 gradient-text inline-block">Portfolio</h3>
              <p className="text-muted-foreground text-sm leading-relaxed">
                Senior frontend engineer crafting bold, performant digital experiences.
              </p>
            </div>

            <div>
              <h3 className="font-bold text-foreground mb-3 text-sm font-mono uppercase tracking-wider">
                Quick Links
              </h3>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-border/50">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} Chlaudya Margareta. All rights reserved.
          </p>
          <Button
            variant="ghost"
            size="sm"
