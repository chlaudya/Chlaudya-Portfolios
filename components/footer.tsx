        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://github.com/chlaudya" className="hover:opacity-80 transition-opacity">
              ...
              <a href="https://www.linkedin.com/in/margareta-ch-a50434118/" className="hover:opacity-80 transition-opacity">
